...
const ToolButton = ({ active, onClick, children, title }: ToolButtonProps) => (
  <button
    className={`p-2 rounded-md ${active ? 'bg-blue-100 text-blue-600' : 'text-gray-700 hover:bg-gray-200'}`}
    onClick={onClick}
    title={title}
  >
    {children}
  ...
  return (
    <div className="flex space-x-2">
      ...
      <ToolButton
        ...
        title="Undo"
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={canUndo ? "currentColor" : "#ccc"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <ToolButton
        ...
        title="Redo"
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={canRedo ? "currentColor" : "#ccc"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
